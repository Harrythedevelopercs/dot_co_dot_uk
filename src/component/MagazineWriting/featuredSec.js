  ...
  return (
    <>
      <section className='w-full bg-white text-[#1d1d1f] py-4 font-secondary'>
        ...
        <div className='max-w-7xl container mx-auto pt-32 pb-56 md:py-10 xs:pt-10 xs:pb-0 text-left justify-center items-center ' >

          <div className='flex md:grid  xs:grid xs:grid-cols-1 items-center' >
            <div className='md:w-[90%] mx-auto xs:w-[100%] xs:py-5 xs:px-6 md:text-center xs:text-center  '>
              <h1 className='md:w-[90%] font-bold leading-[60px] text-5xl mt-12 xs:mt-0 xs:text-4xl xs:w-[100%]'>
                {props.title}
              </h1>
              <p className='md:w-[90%] mt-3 xs:w-[100%]'>
                {props.dec}
              </p>
              <div className='w-[60%] md:w-[60%] grid grid-cols-2 grid-rows-1 gap-x-5 py-4 md:mx-auto xs:w-[100%]'>
            ...
            <div className='xl:hidden 2xl:hidden lg:hidden mx-auto justify-center items-center text-center md:pb-0 xs:w-[90%] xs:pb-0 ' >
              <Image src={'/assets/images/newimg/medium-magazine-writing.png'} width={800} height={600} alt='medium-magazine-writing' />
            </div>

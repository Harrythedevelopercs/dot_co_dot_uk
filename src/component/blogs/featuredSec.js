  ...
  return (
    <section className='w-full bg-white text-[#1d1d1f] py-4 xs:py-0 font-secondary'>
      <div className='relative -z-0'>
        <div
          className="absolute md:hidden sm:hidden xs:hidden top-0 right-0 w-[650px] h-[500px] bg-no-repeat bg-right md:bg-center"
          style={{ backgroundImage: "url('/assets/images/newimg/blog-banner.png')" }}
        ></div>
      </div>
      <div className=' container max-w-7xl mx-auto text-left justify-center items-center py-28 xs:py-0 xs:pt-10 xs:pb-5' >
        <div className='flex md:grid xs:grid xs:grid-cols-1 items-center' >
          <div className='basis-[60%] xs:w-[100%] xs:py-5 xs:px-6 g-2 xs:text-center md:text-center '>
            <h1 className='w-[70%] font-bold leading-[60px] text-5xl xs:text-3xl xs:w-[100%] md:w-[100%]'>
              {props.title}
            </h1>
            <p className='mt-3 xs:w-[100%] md:w-[90%] md:mx-auto xs:mx-auto'>
              {props.dec}
            </p>
            <div className='w-[50%] grid grid-cols-2 grid-rows-1 gap-5 py-5 md:mx-auto xs:mx-auto xs:w-[100%]'>
          ...
          <div className='xl:hidden 2xl:hidden lg:hidden mx-auto justify-center items-center text-center md:pb-0 xs:w-[90%] xs:pb-0 md:mt-12 xs:mt-12 ' >
              <Image src={'/assets/images/newimg/blog-banner.png'} width={600} height={600} alt='blog-banner' />
            </div>

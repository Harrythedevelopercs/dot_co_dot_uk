                ...
                <div className="container mx-auto max-w-7xl z-10 relative">
                    ...
                    <div className="grid grid-cols-3 grid-rows-1 space-y-5 space-x-5 md:w-[90%]">
                        <div className='flex-rows justify-center items-center text-center pt-5 pl-5'>
                             <Image width={50} height={50} className='' src='/assets/images/newimg/script-writing-1.jpg'/>
                            <h3 className='text-2xl font-bold'>Film <br></br> Writing</h3>
                        </div>

                        <div className='flex-rows justify-center items-center text-center'>
                             <Image width={50} height={50} className='' src='/assets/images/newimg/script-writing-2.jpg'/>
                            <h3 className='text-2xl font-bold'>Video <br></br>Scripting</h3>
                        </div>
                        
                        <div className='flex-rows justify-center items-center text-center'>
                             <Image width={50} height={50} className='' src='/assets/images/newimg/script-writing-3.jpg'/>
                            <h3 className='text-2xl font-bold'>Documentary <br></br> Scripting</h3>
                        </div>

                        <div className='flex-rows justify-center items-center text-center'>
                             <Image width={50} height={50} className='' src='/assets/images/newimg/script-writing-4.jpg'/>
                            <h3 className='text-2xl font-bold'>Story <br></br> Scripting</h3>
                        </div>

                        <div className='flex-rows justify-center items-center text-center'>
                             <Image width={50} height={50} className='' src='/assets/images/newimg/script-writing-5.jpg'/>
                            <h3 className='text-2xl font-bold'>Manuscript <br></br> Scripting</h3>
                        </div>

                        <div className='flex-rows justify-center items-center text-center'>
                             <Image width={50} height={50} className='' src='/assets/images/newimg/script-writing-6.jpg'/>

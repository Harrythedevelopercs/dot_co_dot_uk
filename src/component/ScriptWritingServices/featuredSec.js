  ...
  return (
    <>
      <section className='w-full bg-white text-[#1d1d1f] py-4 font-secondary'>
        <div className='max-w-7xl container mx-auto text-left justify-center items-center  md:text-center' >
          <div className='flex xs:grid xs:grid-cols-1 md:grid items-center md:mt-10 md:text-center' >
            <div className='basis-[50%] xs:w-[100%] xs:py-5 xs:px-6 md:mx-auto md:w-[95%] sm:w-[90%] xs:text-center '>
              <h1 className=' font-bold leading-[55px] text-5xl md:text-5xl xs:text-3xl md:mx-auto md:w-[90%] xs:w-[100%]'>
                {props.title}
              </h1>
              <p className='mt-3 w-[90%] md:mx-auto sm:mx-auto xs:mx-auto md:w-[90%] sm:w-[100%] xs:w-[100%]'>
                {props.dec}
              </p>
              <div className='w-[60%] md:mx-auto  grid grid-cols-2 grid-rows-1 gap-x-5 py-5 xs:w-[100%] xs:mx-auto'>
            ...
            <div className='basis-[50%] mx-auto justify-center items-center text-center xs:w-[90%] xs:pb-10 ' >
              <Image width={400} height={400} src='/assets/images/newimg/script-writing-banner.png' className='mx-auto' alt='seo-featured-banner' />
            </div>
          </div>

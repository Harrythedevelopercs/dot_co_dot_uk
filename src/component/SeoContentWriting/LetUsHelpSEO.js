            ...
            <section className="py-[100px]">
                <div className="container max-w-7xl font-secondary">
                    <div className="text-center justify-content-center ">
                        ...
                        <p className='max-w-[80%] mx-auto my-3 text-[#05193c] xs:text-justify xs:max-w-[90%]'>
                    ...
                    <div className={`grid w-[80%] md:w-[90%] ${isLargeScreen ? '' : 'hidden'} mx-auto md:grid-cols-2 grid-cols-3 gap-5 mt-12 items-stretch justify-stretch xs:grid-cols-1 xs:px-5 md:px-5`}>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={50} height={50} className='mx-auto mb-5  ' src="/assets/images/newimg/reasearch.png" alt="Seal of Approval" />
                                <h4 className='text-xl font-semibold mx-auto '>Research <br></br> FAQ Section</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={65} height={50} className='mx-auto mb-5 ' src="/assets/images/newimg/copywriting.png" alt="Seal of Approval" />
                                <h4 className='text-xl font-semibold mx-auto '>SEO Copywriting <br></br> and Editing</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={65} height={65} className='mx-auto mb-5 ' src="/assets/images/newimg/seo.png" alt="Seal of Approval" />
                                <h4 className='text-xl font-semibold mx-auto '>SEO Titile and <br></br> Meta Description</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={65} height={65} className='mx-auto mb-5 ' src="/assets/images/newimg/Professional.png" alt="Seal of Approval" />
                                <h4 className='text-xl font-semibold mx-auto '>Professional <br></br> Analysis </h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={65} height={65} className='mx-auto mb-5 ' src="/assets/images/newimg/Optimization.png" alt="Seal of Approval" />
                                <h4 className='text-xl font-semibold mx-auto '>Effective Keyword <br></br> Optimization</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={65} height={65} className='mx-auto mb-5 ' src="/assets/images/newimg/link.png" alt="Seal of Approval" />
                    ...
                    <div className={`grid xs:w-[90%] ${isLargeScreen ? 'hidden' : ''} mx-auto gap-5 mt-12 items-stretch justify-stretch xs:grid-cols-1 xs:px-5 md:px-5`}>
                        <Slider {...settings}>
                        <div className="  ">
                            <div className="hover:shadow-lg hover:shadow-[#777777] hover:-translate-y-1 hover:scale-95  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={80} height={60} className='mx-auto mb-5  ' src="/assets/images/newimg/reasearch.png" alt="Seal of Approval" />
                                <h4 className='text-xl font-semibold mx-auto '>Research <br></br> FAQ Section</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-lg hover:shadow-[#777777] hover:-translate-y-1 hover:scale-95  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={80} height={80} className='mx-auto mb-5 ' src="/assets/images/newimg/copywriting.png" alt="Seal of Approval" />
                                <h4 className='text-xl font-semibold mx-auto '>SEO Copywriting <br></br> and Editing</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-lg hover:shadow-[#777777] hover:-translate-y-1 hover:scale-95  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={80} height={80} className='mx-auto mb-5 ' src="/assets/images/newimg/seo.png" alt="Seal of Approval" />
                                <h4 className='text-xl font-semibold mx-auto '>SEO Titile and <br></br> Meta Description</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-lg hover:shadow-[#777777] hover:-translate-y-1 hover:scale-95  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={80} height={80} className='mx-auto mb-5 ' src="/assets/images/newimg/Professional.png" alt="Seal of Approval" />
                                <h4 className='text-xl font-semibold mx-auto '>Professional <br></br> Analysis </h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-lg hover:shadow-[#777777] hover:-translate-y-1 hover:scale-95  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={80} height={80} className='mx-auto mb-5 ' src="/assets/images/newimg/Optimization.png" alt="Seal of Approval" />
                                <h4 className='text-xl font-semibold mx-auto '>Effective Keyword <br></br> Optimization</h4>
                            </div>
                        </div>
                        <div className="  ">
                            <div className="hover:shadow-lg hover:shadow-[#777777] hover:-translate-y-1 hover:scale-95  hover:bg-[#00c0e4] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                <Image width={80} height={80} className='mx-auto mb-5 ' src="/assets/images/newimg/link.png" alt="Seal of Approval" />
                                <h4 className='text-xl font-semibold mx-auto '>In-Depth <br></br> Page Linking</h4>
                            </div>
                        </div>

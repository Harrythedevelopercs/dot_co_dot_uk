  ...
  return (
    <>
      <section className='w-full text-[#1d1d1f] pt-10 pb-32 md:pb-0 sm:pb-0 xs:pb-0 font-secondary'>
        ...
        <div className='max-w-7xl mx-auto grid grid-cols-1 xs:grid-cols-1 text-left justify-center ' >
          <div className='w-[55%] md:mx-auto md:w-[90%] sm:w-[100%] xs:w-[100%]' >
            <div className=' py-10 xs:w-[100%] xs:py-5 xs:px-6 xs:text-center md:text-center '>
              <h1 className=' font-bold leading-[55px] text-5xl mt-12 md:mt-0 xs:mt-0 xs:text-4xl xs:w-[100%]'>
                {props.title}
              </h1>
              <p className='w-[90%] md:w-[100%] sm:w-[100%] mt-3 xs:w-[100%]'>
                {props.dec}
              </p>
              <div className='w-[50%] grid grid-cols-2 grid-rows-1 gap-x-5 py-5 xs:w-[100%] md:mx-auto xs:mx-auto sm:mx-auto'>
          ...
          <div className='mx-auto w-[100%] xl:hidden 2xl:hidden lg:hidden justify-center items-center text-center pb-20 md:pb-0 xs:w-[90%] xs:pb-10 ' >
              <Image src={'/assets/images/newimg/rolled-newspaper11.png'} width={800} height={600} alt='rolled-newspaper11' />
            </div>

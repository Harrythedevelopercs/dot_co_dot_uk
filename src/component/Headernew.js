            ...
            <div className="items-center justify-between flex grid-cols-2 grid-rows-1">
              <div className="flex-shrink-0">
                <Link href="/" className="text-xl font-bold text-indigo-500">
                  <Image src="/assets/images/education-logo.png" alt="Barnett ghostwriting logo" width={180} height={50} />
                </Link>
              </div>
              <nav className="flex space-x-4 text-[16px]   text-[#1d1d1f] font-medium">
                <ul id="menu" className={`${menuOpen ? 'transform translate-x-0 md:hidden xs:hidden sm:hidden' : 'flex transition-transform duration-500  ease-in-out translate-x-0 md:translate-x-0 right-0 xs:text-white sm:text-white  md:text-white md:bg-[#00c0e4] sm:bg-[#00c0e4] md:z-50 sm:z-50 md:text-[18px] xs:text-[18px] sm:text-[18px] md:block xs:block sm:block xs:fixed sm:fixed md:fixed xs:top-0 sm:top-0 md:top-0 sm:py-16 md:py-16 md:w-[70%] md:h-full xs:w-[320px] xs:h-full sm:w-[300px] sm:h-full xs:right-0 md:right-0 xs:px-10 leading-9 xs:py-16 xs:bg-[#00c0e4] xs:z-50  space-x-6 text-[#1d1d1f] '} flex space-x-6 text-[#1d1d1f] cursor-default `}>
                  ...
                  <li className="relative group py-0 hover:text-[#00C0E4] z-50">
                    ...
                    <div className="absolute lg:-left-48 top-3 transition group-hover:translate-y-5 translate-y-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-500 group-hover:transform z-50 min-w-[560px] xs:min-w-[350px] sm:min-w-[350px]">
                              ...
                              <ul className="mt-3 text-[15px]">
                                <li>
                                  <Link href="/affordable-ghostwriting-services" className="flex justify-start align-middle items-center p-3 -mx-2 rounded-lg hover:bg-gradient-to-br hover:from-indigo-50 hover:to-pink-50 hover:via-blue-50 transition ease-in-out duration-300 text-gray-800 font-semibold hover:text-indigo-600">
                                    ...
                                    <span>
                                      <Image className='filter brightness-50 mr-2' src="/assets/images/newimg/ghostwriting.png" width={40} height={40} />
                                    </span>
                                    <span>
                                      Ghostwriting
                                    </span>
                                ...
                                <li>
                                  <Link
                                    ...
                                    className="flex justify-start align-middle items-center p-3 -mx-2 rounded-lg hover:bg-gradient-to-br hover:from-indigo-50 hover:to-pink-50 hover:via-blue-50 transition ease-in-out duration-300 text-gray-800 font-semibold hover:text-indigo-600">                   <span>
                                      <Image className='filter brightness-50 mr-2' src="/assets/images/newimg/SEO-Writing.png" width={40} height={40} />
                                    </span>
                                    <span>
                                      SEO Writing
                                    </span>
                                ...
                                <li>
                                  <Link
                                    ...
                                    <span>
                                      <Image className='filter brightness-50 mr-2' src="/assets/images/newimg/Article-Writing.png" width={40} height={40} />
                                    </span>
                                    <span>
                                      Article Writing
                                    </span>
                                ...
                                <li>
                                  <Link
                                    ...
                                    className="flex justify-start align-middle items-center p-3 -mx-2 rounded-lg hover:bg-gradient-to-br hover:from-indigo-50 hover:to-pink-50 hover:via-blue-50 transition ease-in-out duration-300 text-gray-800 font-semibold hover:text-indigo-600">
                                    <span>
                                      <Image className='filter brightness-50 mr-2' src="/assets/images/newimg/magazine-writing.png" width={40} height={40} />
                                    </span>
                                    <span>
                                      Magazine Writing
                                    </span>
                              ...
                              <ul className="mt-4 text-[15px]">
                                <li>
                                  <Link
                                    ...
                                    className="flex justify-start align-middle items-center p-3 -mx-2 rounded-lg hover:bg-gradient-to-br hover:from-indigo-50 hover:to-pink-50 hover:via-blue-50 transition ease-in-out duration-300 text-gray-800 font-semibold hover:text-indigo-600">
                                    <span>
                                      <Image className='filter brightness-50 mr-2' src="/assets/images/newimg/Web-Copy-Writing.png" width={40} height={40} />
                                    </span>
                                    <span>
                                      Web Copy Writing
                                ...
                                <li>
                                  <Link
                                    ...
                                    className="flex justify-start align-middle items-center p-3 -mx-2 rounded-lg hover:bg-gradient-to-br hover:from-indigo-50 hover:to-pink-50 hover:via-blue-50 transition ease-in-out duration-300 text-gray-800 font-semibold hover:text-indigo-600">
                                    <span>
                                      <Image className='filter brightness-50 mr-2' src="/assets/images/newimg/Press-Release.png" width={40} height={40} />
                                    </span>
                                    <span>
                                      Press Release
                                ...
                                <li>
                                  <Link
                                    ...
                                    className="flex justify-start align-middle items-center p-3 -mx-2 rounded-lg hover:bg-gradient-to-br hover:from-indigo-50 hover:to-pink-50 hover:via-blue-50 transition ease-in-out duration-300 text-gray-800 font-semibold hover:text-indigo-600">
                                    <span>
                                      <Image className='filter brightness-50 mr-2' src="/assets/images/newimg/Script-Writing.png" width={40} height={40} />
                                    </span>
                                    <span>
                                      Script Writing

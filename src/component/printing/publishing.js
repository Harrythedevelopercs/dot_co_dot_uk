            ...
            <section className='publishing-slider font-secondary bg-[#f2f2f2] py-10 xs:py-5'>
                <div className='container max-w-7xl justify-center mt-10 testimonial mx-auto mb-20 testimonial md:px-5 xs:px-7'>
                    <div className='py-10 text-center xs:py-5'>
                        <h6 className='text-xl font-semibold xs:text-base'>Custom high-quality</h6>
                        ...
                        <Slider {...settings}>
                            <div className='mx-auto'>
                                <div className='relative'>
                                    <Image width={240} height={240}  src='/assets/images/newimg/bold-typography.png' alt="bold-typography" />
                                    <div >
                                        <Image  width={240} height={240}  src='/assets/images/newimg/rectangle-11.png' alt="before-image" className='absolute top-0 right-0 bottom-0 left-0' />
                            ...
                            <div className='publishing relative'>
                                <div className='relative'>
                                    <Image  width={240} height={240}  src='/assets/images/newimg/Illustrations.png' alt="Illustrations" />
                                    <div >
                                        <Image  width={240} height={240}  src='/assets/images/newimg/rectangle-11.png' alt="before-image" className='absolute top-0 right-0 bottom-0 left-0' />
                            ...
                            <div className='publishing relative'>
                                <div className='relative'>
                                    <Image  width={240} height={240}  src='/assets/images/newimg/Retro.png' alt="Retro" />
                                    <div >
                                        <Image  width={240} height={240}  src='/assets/images/newimg/rectangle-11.png' alt="before-image" className='absolute top-0 right-0 bottom-0 left-0' />
                            ...
                            <div className='publishing relative'>
                                <div className='relative'>
                                    <Image  width={240} height={240}  src='/assets/images/newimg/millennial-pink.png' alt="millennial-pink" />
                                    <div >
                                        <Image  width={240} height={240}  src='/assets/images/newimg/rectangle-11.png' alt="before-image" className='absolute top-0 right-0 bottom-0 left-0' />
                            ...
                            <div className='publishing relative'>
                                <div className='relative'>
                                    <Image  width={240} height={240}  src='/assets/images/newimg/colorful-children.png' alt="Colorful children books illustrations" />
                                    <div >
                                        <Image  width={240} height={240}  src='/assets/images/newimg/rectangle-11.png' alt="before-image" className='absolute top-0 right-0 bottom-0 left-0' />
                            ...
                            <div className='publishing relative'>
                                <div className='relative'>
                                    <Image  width={240} height={240}  src='/assets/images/newimg/designs-for-classic-literature.png' alt="designs-for-classic-literature" />
                                    <div >
                                        <Image  width={240} height={240}  src='/assets/images/newimg/rectangle-11.png' alt="before-image" className='absolute top-0 right-0 bottom-0 left-0' />
                            ...
                            <div className='publishing relative'>
                                <div className='relative'>
                                    <Image  width={240} height={240}  src='/assets/images/newimg/photography.png' alt="photography.png" />
                                    <div >
                                        <Image  width={240} height={240}  src='/assets/images/newimg/rectangle-11.png' alt="before-image" className='absolute top-0 right-0 bottom-0 left-0' />
                            ...
                            <div className='publishing relative'>
                                <div className='relative'>
                                    <Image  width={240} height={240}  src='/assets/images/newimg/minimalist-covers.png' alt="minimalist-covers" />
                                    <div >
                                        <Image  width={240} height={240}  src='/assets/images/newimg/rectangle-11.png' alt="before-image" className='absolute top-0 right-0 bottom-0 left-0' />
                            ...
                            <div className='publishing relative'>
                                <div className='relative'>
                                    <Image  width={240} height={240}  src='/assets/images/newimg/Portrait.png' alt="Portrait" />
                                    <div >
                                        <Image  width={240} height={240}  src='/assets/images/newimg/rectangle-11.png' alt="before-image" className='absolute top-0 right-0 bottom-0 left-0' />
                            ...
                            <div className='publishing relative'>
                                <div className='relative'>
                                    <Image  width={240} height={240}  src='/assets/images/newimg/Classic.png' alt="Classic" />
                                    <div >
                                        <Image  width={240} height={240}  src='/assets/images/newimg/rectangle-11.png' alt="before-image" className='absolute top-0 right-0 bottom-0 left-0' />
                            ...
                            <div className='publishing relative'>
                                <div className='relative'>
                                    <Image  width={240} height={240}  src='/assets/images/newimg/hand-drawn-covers.png' alt="hand-drawn-covers" />
                                    <div >
                                        <Image  width={240} height={240}  src='/assets/images/newimg/rectangle-11.png' alt="before-image" className='absolute top-0 right-0 bottom-0 left-0' />

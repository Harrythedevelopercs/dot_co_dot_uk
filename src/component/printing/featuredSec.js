...
const GhostwritingBanner = (props) => {
  ...
  return (
   ...
   <div className='relative -z-0'>
        ...
        <div className=' container max-w-7xl mx-auto text-left justify-center items-center pt-28 pb-36 md:pt-20 md:pb-0 xs:pt-0 xs:pb-0' >
          <div className='flex md:grid xs:grid xs:grid-cols-1 items-center xs:text-center md:text-center' >
            <div className='basis-[50%] md:text-center  md:w-[100%] xs:w-[100%] xs:py-14 g-2 xs:mx-auto md:mx-auto '>
              <h1 className=' font-bold leading-[60px] text-5xl xs:text-3xl xs:w-[100%]'>
                {props.title}
              </h1>
              <p className='w-[90%] mt-3 md:mx-auto xs:w-[100%]'>
                {props.dec}
              </p>
              <div className='w-[70%] md:mx-auto grid grid-cols-2 grid-rows-1 gap-2 py-5 xs:w-[90%] xs:mx-auto md-mx-auto'>
            ...
            <div className='mx-auto w-[100%] xl:hidden 2xl:hidden lg:hidden justify-center items-center text-center pb-20 md:pb-0 xs:w-[90%] xs:pb-5 ' >
              <Image src={'/assets/images/newimg/man-working-printing-house-with-paper-paints.png'} width={800} height={600} alt='man-working-printing-house-with-paper-paints' />
            </div>

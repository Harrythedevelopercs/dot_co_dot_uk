...
const TabNavigation = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <ul className="flex flex-wrap max-w-6xl gap-x-1 mx-auto gap-y-6 md:gap-y-8 justify-center md:gap-2 xs:gap-x-1 xs:justify-start xs:mx-0 xs:overflow-x-scroll xs:py-5" role="tablist">
      <li className="">
        <a
    ...
    <div>
      ...
      {activeTab === 's1' && (
        <div className='container max-w-7xl px-5 font-secondary mt-10 md:p-5 xs:p-5 pt-3 pb-4'>
           ...
           <div className='bg-[#f2f2f2] rounded-3xl grid grid-cols-2 gap-5 grid-rows-1 xs:grid-cols-1 items-center justify-center font-secondary mb-4'>
            <div>
              <Image width={600} height={600} alt='' src='/assets/images/newimg/blog1.jpg'  className='range-lg bg-transparent rounded-4xl p-5'/>
            </div>
            <div className='space-y-2 px-10 xs:py-10'>
              <h3 className='font-semibold text-[38px] text-black'>Lorem ipsum dolor sit amet</h3>
              <h5 className='text-[14px] text-black' >September 12, 2023 - <span className='text-sky-400'> Book Publishing</span></h5>
              <p className='text-black'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus egestas gravida posuere. Curabitur elementum dui id diam dignissim faucibus.</p>
              <br/>
          ...
          <div className='bg-[#f2f2f2] rounded-3xl grid grid-cols-2 gap-5 grid-rows-1 xs:grid-cols-1 items-center justify-center font-secondary mb-4'>
            <div>
              <Image width={600} height={600} alt='' src='/assets/images/newimg/blog2.jpg'  className='range-lg bg-transparent rounded-4xl p-5'/>
            </div>
            <div className='space-y-2 px-10 xs:py-10'>
              <h3 className='font-semibold text-[38px] text-black'>Lorem ipsum dolor sit amet</h3>
              <h5 className='text-[14px] text-black' >September 12, 2023 - <span className='text-sky-400'> Book Publishing</span></h5>
          ...
          <div className='bg-[#f2f2f2] rounded-3xl grid grid-cols-2 gap-5 grid-rows-1 xs:grid-cols-1 items-center justify-center font-secondary mb-4'>
            <div>
              <Image width={600} height={600} alt='' src='/assets/images/newimg/blog3.jpg'  className='range-lg bg-transparent rounded-4xl p-5'/>
            </div>
            <div className='space-y-2 px-10 xs:py-10'>
              <h3 className='font-semibold text-[38px] text-black'>Lorem ipsum dolor sit amet</h3>
              <h5 className='text-[14px] text-black' >September 12, 2023 - <span className='text-sky-400'> Book Publishing</span></h5>

    ...
    return (
        <>
            <section className="our-bringing6 py-24">
                <div className="container mx-auto max-w-7xl font-secondary">
                    <div className="text-center mb-5 heading">
                        <h6 className="text-[20px] font-semibold">
                            Our Creative Ghostwriters,
                        </h6>
                        <h2 className='text-[40px] font-bold py-1'>
                            Bringing Your Imagination To Life.
                        </h2>
                        <p className="mt-2 max-w-[70%] mx-auto xs:max-w-[95%]">
                    ...
                    <div className="grid grid-cols-2 px-auto md:grid-cols-1 xs:grid-cols-1 ">
                        <div className='px-4 '>
                            ...
                            <div className="w-[60%] grid grid-cols-2 grid-rows-1 gap-x-6 py-5 relative xs:w-[100%]">
                        ...
                        <div className="py-10 pl-5 xs:px-4 md:px-4 xs:justify-center xs:items-center">
                            <Image src="/assets/images/newimg/bringing-your-imagination.png" alt="fiction ghostwriting services" width={1000} height={1000}/>
                        </div>

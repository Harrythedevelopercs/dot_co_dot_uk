            ...
            <section className="py-[100px] relative ">
                <div className="container max-w-7xl relative z-10 font-secondary">
                    <div className="text-center justify-content-center mb-5 xs:px-2 ">
                        <h6 className='text-xl mb-2 font-semibold'>Let Us Help You</h6>
                        <h2 className='text-[40px] font-bold xs:leading-tight'>What Sets Us Apart?</h2>
                        <p className='max-w-[80%] mx-auto mt-3 mb-5 text-[#05193c] xs:text-justify xs:max-w-[90%]'>
                    ...
                    <div className={`${isLargeScreen ? '' : 'hidden'} grid md:grid-cols-2 grid-cols-4 gap-4 mt-10 items-stretch justify-stretch xs:grid-cols-1 xs:px-5 md:px-5`}>
                        <div className="  ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] p-6 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <Image width={80} height={80} className='mx-auto my-12 ' src="/assets/images/newimg/checkmark.png" alt="Seal of Approval" />
                        ...
                        <div className=" ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] p-6 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <Image width={80} height={80} className='mx-auto my-12' src="/assets/images/newimg/checkmark.png" alt="Reviewed by editors" />
                        ...
                        <div className=" ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] p-6 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <Image width={80} height={80} className='mx-auto my-12' src="/assets/images/newimg/checkmark.png" alt="Unlimited Revisions" />
                        ...
                        <div className=" ">
                            <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] p-6 px-auto items-center justify-center mx-auto rounded-3xl">
                                ...
                                <Image width={80} height={80} className='mx-auto my-12' src="/assets/images/newimg/checkmark.png" alt="Rights of Ownership Maintained" />
                    ...
                    <div className={`${isLargeScreen ? 'hidden' : ''} grid md:grid-cols-2 grid-cols-4 gap-4 mt-10 items-stretch justify-stretch xs:grid-cols-1 xs:px-10 md:px-5`}>
                        <Slider {...settings}>
                        <div className="  ">

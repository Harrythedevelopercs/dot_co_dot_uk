            ...
            <section className="py-[100px] relative ">
                <div className="container max-w-7xl relative z-10 font-secondary">
                    <div className="text-center justify-content-center ">
                        ...
                        <p className='max-w-[80%] mx-auto my-5  xs:text-justify xs:max-w-[90%]'>
                    ...
                    <div className="  ">
                                <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                    <Image className='mx-auto mb-8 hover:invert-1 hover:brightness-100 hover:grayscale ' src="/assets/images/newimg/checkmark.png" alt="Seal of Approval" width={100} height={100} />
                                    <h4 className='text-xl font-semibold mx-auto '>Original Key-word  <br></br> optimized content</h4>
                                </div>
                            </div>
                            <div className="  ">
                                <div className="hover:shadow-2xl hover:shadow-[#777777] hover:-translate-y-1 hover:scale-105 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                    <Image className='mx-auto mb-8 ' src="/assets/images/newimg/checkmark.png" alt="Seal of Approval" width={100} height={100} />
                    ...
                    <div className={`grid w-[80%] mx-auto ${isLargeScreen ? 'hidden' : ''} grid-cols-3 gap-4 mt-12 items-stretch justify-stretch xs:grid-cols-1 xs:px-0 md:px-0`}>
                        ...
                        <div className="  ">
                                <div className="hover:shadow-lg hover:shadow-[#777777] hover:-translate-y-1 hover:scale-95 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                    <Image className='mx-auto mb-8 hover:invert-1 hover:brightness-100 hover:grayscale ' src="/assets/images/newimg/checkmark.png" alt="Seal of Approval" width={70} height={70} />
                                    <h4 className='text-xl font-semibold mx-auto '>Original Key-word  <br></br> optimized content</h4>
                                </div>
                            </div>
                            <div className="  ">
                                <div className="hover:shadow-lg hover:shadow-[#777777] hover:-translate-y-1 hover:scale-95 hover:bg-[#1d1d1f] duration-300 hover:text-white box text-center bg-[#f2f2f2] py-16 px-auto items-center justify-center mx-auto rounded-3xl">
                                    <Image className='mx-auto mb-8 ' src="/assets/images/newimg/checkmark.png" alt="Seal of Approval" width={70} height={70} />
                                    <h4 className='text-xl font-semibold mx-auto '>Content writing <br></br>and editing services</h4>
                                </div>
                            </div>
                            <div className="  ">

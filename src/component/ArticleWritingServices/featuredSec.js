        ...
        <div className='relative'>
          ...
          <div className='max-w-7xl mx-auto text-left justify-center'>
            <div className='grid grid-cols-1 '>
              <div className='w-[80%]  md:w-[100%] md:mx-auto md:px-10  pt-20 pb-40 md:pt-16 md:pb-0 xs:pt-5 xs:pb-5 xs:w-[90%] xs:mx-auto'>
                <h1 className='w-[70%] md:w-[90%] font-bold leading-[60px] text-5xl md:text-5xl mt-12 md:mt-1 xs:text-3xl xs:w-[100%]   '>
                  {props.title}
                </h1>
                <p className='w-[60%] md:w-[90%] mt-3 xs:w-[90%]'>
                  {props.dec}
                </p>
              ...
              <div className='w-[100%] lg:hidden xl:hidden 2xl:hidden   pb-40 md:pb-0 xs:w-[90%] xs:pb-10'>
                <Image src='/assets/images/newimg/article-banner.png' width={750} height={400} objectFit='fill'/>
              </div>

              <div className='w-[100%] xs:hidden md:hidden pb-40 md:pb-10 xs:w-[90%] xs:pb-10'>
                {/* <Image src='/assets/images/newimg/article-banner.png' width={750} height={400} objectFit='fill'/> */}
              </div>
            </div>
          </div>

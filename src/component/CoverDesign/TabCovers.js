...
const TabNavigation = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <ul className="flex xs:overflow-x-scroll xs:space-x-5 xs:m-0 max-w-7xl mx-auto justify-center items-center xs:justify-start xs:mx-0 " role="tablist">
      <li className="mr-2">
        <a
...
const ParentComponent = () => {
  ...
  return (
    <div>
      ...
      {activeTab === 's1' && (
        <div className='container max-w-6xl md:max-w-2xl text-[#1d1d1f] pt-14'>
          <div className='grid grid-cols-2 grid-rows-1 xs:grid-cols-1 items-center justify-center font-secondary'>
            <div className='space-y-2'>
              <h3 className='font-semibold text-[40px] md:text-4xl'>Dust jacket cover</h3>
              <p>As its name suggests, a dust jacket, provided by a professional book writing agency, keeps dust from getting on a book's cover. Additionally it shields the book from harmful spills, scuffs, and dirt. As a result, a gloss or matte laminate is frequently used to boost a dust jacket's longevity and stain resistance.

The dust jacket cover makes your book look sleek, attracting your readers. In addition, we provide instant delivery of your work.</p>
              <div className='w-[50%] grid grid-cols-2 grid-rows-1 gap-x-5 py-5 md:w-[100%] xs:w-[90%]'>
            ...
            <div>
            <Image className='mx-auto' width={500} height={600} alt='Tablist Images' src='/assets/images/newimg/dust-cover.png'/>
            </div>
      ...
      {activeTab === 's2' && (
        <div className='container max-w-6xl md:max-w-2xl text-[#1d1d1f] pt-14'>
          ...
          <div className='grid grid-cols-2 grid-rows-1 xs:grid-cols-1 items-center justify-center font-secondary'>
            ...
            <div>
            <Image className='mx-auto' width={300} height={600} alt='Tablist Images' src='/assets/images/newimg/hardboard-cover.png'/>
            </div>
      ...
      {activeTab === 's3' && (
        <div className='container max-w-6xl md:max-w-2xl text-[#1d1d1f] pt-14'>
          ...
          <div className='grid grid-cols-2 grid-rows-1 xs:grid-cols-1 items-center justify-center font-secondary'>
            ...
            <div>
            <Image className='mx-auto' width={400} height={600} alt='Tablist Images' src='/assets/images/newimg/paper-book-cover.png'/>
            </div>

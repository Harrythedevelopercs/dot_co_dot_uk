            ...
            <section className="py-[80px] font-secondary md:py-10">
                <div className='container max-w-7xl'>
                    <div className='flex gap-5 xs:grid xs:grid-cols-1'>
                        <div className='basis-[40%] items-center md:hidden xs:hidden'>
                            <Image width={600} height={300} alt='outstanding-cover' className=' hover:-translate-y-1 hover:scale-110' src='/assets/images/newimg/outstanding-cover.png' />
                        </div>
                        <div className='basis-[60%] xs:px-5 md:px-12 md:basis-[100%]'>
                            <div className='w-[90%] md:w-[100%] xs:py-5 xs:w-[100%]'>
                                ...
                                <ul className="grid grid-cols-2 xs:grid-cols-1 md:w-[100%] xs:w-[100%] md:mb-10">
                                    <li className='flex gap-4 border-b-2 border-solid border-[#989898] py-3 mr-10 xs:mr-0 md:mr-5'>
                                        <Image width={300} height={300} src="/assets/images/newimg/color-check1.png" alt="Checkmark" className="inline-block h-5 w-5 hover:invert-75" />
                                ...
                                <div className='w-[60%] grid md:mx-auto grid-cols-2 grid-rows-1 gap-x-5 py-5 sm:w-[100%] xs:w-[100%]'>

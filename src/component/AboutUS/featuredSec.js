    ...
    <section className='w-full bg-white text-[#1d1d1f] py-4 font-secondary'>
       <div className='relative -z-0'>
        ...
        <div className='relative z-20 container max-w-7xl mx-auto text-left justify-center items-center py-36 md:py-10 xs:py-0' >
          <div className='grid md:grid-cols-2 xs:grid xs:grid-cols-1 xs:text-center items-center' >
            <div className='w-[55%] md:w-[100%] xs:w-[100%] xs:py-5 xs:px-6 g-2 md:px-5 '>
              <h1 className=' font-bold leading-[60px] text-5xl md:text-4xl xs:text-4xl xs:w-[100%]'>
                {props.title}
              </h1>
              <p className='w-[80%] mt-3 md:w-[100%] xs:w-[100%]'>
                {props.dec}
              </p>
              <div className='w-[50%] md:w-[80%] grid grid-cols-2 grid-rows-1 gap-5 py-5 xs:w-[100%]'>

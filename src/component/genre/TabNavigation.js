...
const ParentComponent = () => {
  ...
  return (
    <div>
      ...
      {activeTab === 's1' && (
        <div className='container max-w-7xl md:max-w-2xl text-[#1d1d1f] pt-20 xs:pt-10'>
          <div className='grid grid-cols-2 grid-rows-1 xs:grid-cols-1 xs:gap-y-10 items-center justify-center font-secondary'>
            <div className='space-y-2'>
              ...
              <h3 className='font-bold text-[40px] md:text-4xl xs:leading-tight xs:text-3xl'>Top-ranked fiction writing services</h3>
              ...
              <div className='w-[60%] grid grid-cols-2 grid-rows-1 gap-x-5 py-5 md:w-[100%] xs:w-[90%]'>
            ...
            <div>
              <Image width={1000} height={600} alt='Tablist Images' src='/assets/images/newimg/shalf-book.png'/>
            </div>
      ...
      {activeTab === 's7' && (
        <div className='container max-w-7xl md:max-w-2xl text-[#1d1d1f] pt-20 xs:pt-10'>
          ...
          <div className='grid grid-cols-2 grid-rows-1 xs:grid-cols-1 xs:gap-y-10 items-center justify-center font-secondary'>
            ...
            <div>
              <Image width={1000} height={600} alt='Tablist Images' src='/assets/images/newimg/shalf-book.png' className='pt-10'/>
            </div>

...
const cta4 = () => {
  return (
    <>
      <div className=''>
        <div className='container x:w-[100%] relative bg-[#f2f2f2] m-0 mx-auto max-h-[300px] rounded-xl max-w-7xl text-left items-center py-20 md:py-10 text-white md:px-5 xs:px-5 xs:py-10'>
          <div className='grid grid-cols-2 grid-rows-1 xs:grid-cols-1  xs:justify-center xs:align-center'>
            <div className='py-0 pl-24 md:pl-0 xs:pl-0'>
            ...
            <div className='xs:hidden md:m-0'>
              <img className='z-10 relative md:left-28 xs:-m-100 xs:left-10 md:-m-20 -m-32 left-56' src='/assets/images/newimg/stack-books-with-word-title.png'/>
            </div>
          </div>

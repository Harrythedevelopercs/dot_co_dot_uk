            ...
            <section className="our-process bg-[#f2f2f2] w-full font-secondary">
                <div className="container max-w-7xl py-24 xs:py-14 text-[#1d1d1f]">
                    <div className="text-center mb-10 justify-center">
                        ...
                        <h2 className='text-[40px] font-semibold leading-10 my-5  xs:text-3xl'>
                            The process of us marketing your product
                        </h2>
                        <p className='w-[80%] mx-auto md:w-[90%] xs:w-[100%]'>
                            We will discuss down below how we get you the recognition and fame with the help of our marketing services. Our marketing team is adept at changing situations within the market as well as being capable of utilizing the best practices that lead to the most attention and attraction towards your product whatever it might be.
                        </p>
                    </div>

                    <div className={`${isLargeScreen ? '' : 'hidden'} grid grid-cols-3 gap-4 md:grid-cols-2 xs:grid-cols-1 md:w-[90%] mx-auto xs:w-[90%]`}>
                        <div className="col-md hover:-translate-y-1 hover:scale-105 duration-300 hover:text-white">
                            <div className="box rounded-2xl bg-white text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-8 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                <h5 className='text-[#d9d9d9] hover:text-[#00C0E4] text-lg font-semibold'>Step 01</h5>
                                <h3 className='text-[20px] text-xl my-2 font-semibold'>Sign Up</h3>
                        ...
                        <div className="col-md hover:-translate-y-1 hover:scale-105 duration-300">
                            <div className="box rounded-2xl bg-white text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-8 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                ...
                                <h3 className='text-[20px] text-xl my-2 font-semibold'>Marketing Review</h3>
                                <p className='text-[16px] text-[#242424] leading-5'>
                        ...
                        <div className="col-md hover:-translate-y-1 hover:scale-105 duration-300">
                            <div className="box rounded-2xl bg-white text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-8 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                ...
                                <h3 className='text-[20px] text-xl my-2 font-semibold'>Research</h3>
                                <p className='text-[16px] text-[#242424] leading-5'>
                        ...
                        <div className="col-md hover:-translate-y-1 hover:scale-105 duration-300">
                            <div className="box rounded-2xl bg-white text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-8 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                ...
                                <h3 className='text-[20px] text-xl my-2 font-semibold'>Target audience selection</h3>
                                <p className='text-[16px] text-[#242424] leading-5'>
                        ...
                        <div className="col-md hover:-translate-y-1 hover:scale-105 duration-300">
                            <div className="box rounded-2xl bg-white text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-8 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                ...
                                <h3 className='text-[20px] text-xl my-2 font-semibold'>Making it look good</h3>
                                <p className='text-[16px] text-[#242424] leading-5'>
                        ...
                        <div className="col-md hover:-translate-y-1 hover:scale-105 duration-300">
                            <div className="box rounded-2xl bg-white text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-8 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                ...
                                <h3 className='text-[20px] text-xl my-2 font-semibold'> Submitting it for review</h3>
                                <p className='text-[16px] text-[#242424] leading-5'>
                    ...
                    <div className={`${isLargeScreen ? 'hidden' : ''} grid grid-cols-3 gap-4 md:grid-cols-2 xs:grid-cols-1 md:w-[90%] mx-auto xs:w-[90%]`}>
                        <Slider {...settings}>
                        <div className="col-md hover:-translate-y-1 hover:scale-95 duration-300 hover:text-white">
                            <div className="box rounded-2xl bg-white text-left text-[#1d1d1f] hover:text-white h-[100%] py-10 px-8 border-2 border-solid transition-[.5s] hover:bg-[#1d1d1f] hover:border-white">
                                <h5 className='text-[#d9d9d9] hover:text-[#00C0E4] text-lg font-semibold'>Step 01</h5>
                                <h3 className='text-[20px] text-xl my-2 font-semibold'>Sign Up</h3>
                                <p className='text-[16px] text-[#242424] leading-5'>

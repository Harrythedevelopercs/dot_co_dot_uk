...
function VerticalNavTabs() {
  ...
  return (
    <div className="tab-vertical md:max-w-2xl md:mx-auto flex font-secondary max-h-[490px] xs:hidden" >
      <div className="w-1/4 text-[#1d1d1f] items-stretch  h-[500px] overflow-y-scroll" id='style-2'>
      ...
      <div className="w-3/4  bg-transparent items-center pl-32 py-24 md:pl-10 md:py-14 text-[#1d1d1f]">
        {activeTab === 1 && <div>
          <h6 className='text-xl'>Publishing</h6>
          <h3 className='text-[40px] leading-[60px] gap-10 font-semibold'>Personal marketing assistants:</h3>
          ...
          <div className='w-[40%] text-center grid grid-cols-2 grid-rows-1 gap-2 py-5 xs:w-[60%]'>
        ...
        {activeTab === 2 && <div>
          <h6 className='text-xl'>Publishing</h6>
          <h3 className='text-[40px] leading-[60px] gap-10'>Personal marketing assistants:</h3>
          <p>We will provide personal marketing assistants who help promote, manage and run promotional campaigns for your book launch through various online and offline channels They will proide you fits your needs!</p>
          <div className='w-[50%] grid grid-cols-2 grid-rows-1 gap-2 py-5 xs:w-[60%]'>
            <button className='bg-[#00C0E4] py-1 text-white hover:bg-transparent hover:border-solid hover:border-[1px] hover:border-[#1d1d1f] hover:text-[#1d1d1f] hover:transition-all hover:transform-gpu'>Get Started</button>
            <button className='bg-[#1d1d1f] py-1 text-white border-solid border-[#1d1d1f] border-[1px] hover:bg-[#00C0E4] hover:text-[#fff] hover:border-[1px] hover:border-[#00C0E4]'>Live Chat</button>
          </div>
        </div>}

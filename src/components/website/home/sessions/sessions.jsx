                    ...
                    <div className={style._flex}>
                        <div className={style.left}>
                                    ...
                                    data.map((e) => ( 
                                        <li key={e} className={style.items}>
                                            ...
                                            <svg width="28" height="29" viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect y="0.48999" width="28" height="28" rx="5" fill="#2997D8" />
                            ...
                            <div className={style.cta}>
                                <CTA icon={false} text="Learn More" link="javascript:;" css="hover:bg-black hover:border hover:border-white hover:[boxShadow:0px_5px_15px_rgba(255,_118,_117,_0.3)] bg-gradient hover:bg-none" />
                                <CTA icon="call" css="bg-transparent border-2 border-white hover:text-lightBlue hover:border-lightBlue [&>img]:brightness-0 [&>img]:invert [&:hover>img]:invert-0 [&:hover>img]:brightness-[inherit]" text="3026653381" link="tel:3026653381" />
                            </div>
                        </div>
                        <div>

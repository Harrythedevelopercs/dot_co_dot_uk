                    ...
                    <div className={style._flex}>
                        <div className={style.left}>
                            ...
                            <div className={style.cta}>
                                ...
                                <CTA icon="call" css="bg-transparent border-2 border-white hover:text-lightBlue hover:border-lightBlue [&>img]:brightness-0 [&>img]:invert [&:hover>img]:invert-0 [&:hover>img]:brightness-[inherit]" text="447577316052" link="tel:447577316052" />
                            </div>
                        </div>
                        <div>

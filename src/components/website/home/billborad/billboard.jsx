                    ...
                    <div className={styles.__grid}>
                        <div className={styles.card}>
                            ...
                            <div className={styles.cta}>
                                ...
                                <CTA icon="call-pink" css="bg-transparent border-2 text-black border-black hover:text-lightBlue hover:border-lightBlue [&>img]:brightness-0 [&>img]:invert-0 [&:hover>img]:brightness-[inherit] [&:hover>img]:invert" />
                            </div>
                        </div>
                    </div>
                </div>

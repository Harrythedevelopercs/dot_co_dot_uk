...
export function CTAGroupReviews() {
    return (
        <>
            ...
            <CTA icon="chevron-pink" css="bg-transparent border-2 text-black border-black hover:text-lightBlue hover:border-lightBlue [&>img]:brightness-0 [&>img]:invert-0 [&:hover>img]:brightness-[inherit] [&:hover>img]:invert !rounded-full" text="Clutch review" />
        </>
    )
};
...
export const metadata = {
  title: "Best Publishing Service, LLC",
  description: "Generated by Best Publishing Service, LLC",
  robots: {
    index: true,
    follow: true,
    nocache: true,
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      />
      <noscript>
        <a href="https://www.livechat.com/chat-with/19207759/" rel="nofollow">
          Chat with us
        </a>, powered by{" "}
